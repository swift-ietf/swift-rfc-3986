...
extension RFC_3986.Parse {
    ...
    public struct Host<Input: Collection.Slice.`Protocol`>: Sendable
...
extension RFC_3986.Parse.Host {
    public enum Error: Swift.Error, Sendable, Equatable {
        case unterminatedIPLiteral
    }
}

extension RFC_3986.Parse.Host: Parser.`Protocol` {
    public typealias ParseOutput = Input
    public typealias Failure = RFC_3986.Parse.Host<Input>.Error
